...
@section('form')
    ...
    <div class="mb-5 mb-md-7">
        <h2 class="h3 text-primary text-uppercase" style="text-align: center"><strong> Register To Access Your Account </strong> </h2>
        <p class="text-white" style="margin-top: -10px;">...new here and don't have an account? <a href="{{route('login.social-media')}}"> <strong> Login </strong></a></p>
    </div>
    <!-- End Title -->
    ...
    <div class="row col-12 mt-2">
        <div class="col-6">
            <a class="btn btn-block btn-white" href="{{route('register.email')}}">
