...
<head>
  ...
  <body class="   footer-offset">
      ...
      <script src="{{asset('backend/assets/vendor/hs-navbar-vertical-aside/hs-navbar-vertical-aside-mini-cache.js')}}"></script>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="layoutSkinsRadio1">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/layouts-sidebar-default.svg')}}" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="layoutSkinsRadio2">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/layouts-sidebar-dark.svg')}}" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="layoutSkinsRadio3">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/layouts-sidebar-light.svg')}}" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="sidebarLayoutOptions1">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/sidebar-default-classic.svg')}}" alt="Image Description">
                    </label>
                    <span class="custom-checkbox-card-text">Default</span>
                  </div>
                </div>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="sidebarLayoutOptions2">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/sidebar-compact.svg')}}" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="sidebarLayoutOptions3">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/sidebar-mini.svg')}}" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="headerLayoutOptions1">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/header-default-fluid.svg')}}" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="headerLayoutOptions2">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/header-default-container.svg')}}" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="headerLayoutOptions3">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/header-double-line-fluid.svg')}}" alt="Image Description">
                    </label>
                ...
                <div class="text-center">
                  <div class="custom-checkbox-card mb-2">
                    ...
                    <label class="custom-checkbox-card-label" for="headerLayoutOptions4">
                      <img class="custom-checkbox-card-img" src="{{asset('backend/assets/svg/layouts/header-double-line-container.svg')}}" alt="Image Description">
                    </label>
  ...
  <div class="navbar-nav-wrap">
    <div class="navbar-brand-wrapper">
      ...
      <a class="navbar-brand" href="index.html" aria-label="Front">
        ...
        <img class="navbar-brand-logo-mini" src="{{asset('backend/assets/svg/logos/logo-short.svg')}}" alt="Logo">
      </a>
      <!-- End Logo -->
    </div>
                          ...
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="avatar avatar-sm avatar-circle">
                                <img class="avatar-img" src="{{asset('backend/assets/img/160x160/img3.jpg')}}" alt="Image Description">
                              </div>
                            </div>
                          </div>
                          <div class="col ml-n3">
                        ...
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="avatar avatar-sm avatar-circle">
                                <img class="avatar-img" src="{{asset('backend/assets/img/160x160/img7.jpg')}}" alt="Image Description">
                              </div>
                            </div>
                          </div>
                          <div class="col ml-n3">
                        ...
                        <div class="row">
                          <div class="col-auto position-static">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="avatar avatar-sm avatar-circle">
                                <img class="avatar-img" src="{{asset('backend/assets/img/160x160/img8.jpg')}}" alt="Image Description">
                              </div>
                            </div>
                          </div>
                          <div class="col ml-n3">
    ...
    <div class="container-fluid">
      <div class="navbar-nav-wrap">
        <div class="navbar-brand-wrapper">
          <!-- Logo -->
          <a class="navbar-brand" href="index.html" aria-label="Front">
            <img class="navbar-brand-logo" src="{{asset('backend/assets/svg/logos/logo-white.svg')}}" alt="Logo">
          </a>
          <!-- End Logo -->
        </div>
                  ...
                  <div class="card-body card-body-height">
                    ...
                    <div class="nav nav-pills flex-column">
                      <a class="nav-link" href="#">
                        <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="{{asset('backend/assets/svg/brands/atlassian.svg')}}" alt="Image Description">
                          </span>
                          <div class="media-body text-truncate">
                            <span class="h5 mb-0">Atlassian</span>
                            <span class="d-block font-size-sm text-body">Security and control across Cloud</span>
                      ...
                      <a class="nav-link" href="#">
                        <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="{{asset('backend/assets/svg/brands/slack.svg')}}" alt="Image Description">
                          </span>
                          <div class="media-body text-truncate">
                            <span class="h5 mb-0">Slack <span class="badge badge-primary badge-pill text-uppercase ml-1">Try</span></span>
                            <span class="d-block font-size-sm text-body">Email collaboration software</span>
                      ...
                      <a class="nav-link" href="#">
                        <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="{{asset('backend/assets/svg/brands/frontapp.svg')}}" alt="Image Description">
                          </span>
                          <div class="media-body text-truncate">
                            <span class="h5 mb-0">Frontapp</span>
                            <span class="d-block font-size-sm text-body">The inbox for teams</span>
                      ...
                      <a class="nav-link" href="#">
                        <div class="media align-items-center">
                          <span class="mr-3">
                            <img class="avatar avatar-xs" src="{{asset('backend/assets/svg/illustrations/review-rating-shield.svg')}}" alt="Image Description">
                          </span>
                          <div class="media-body text-truncate">
                            <span class="h5 mb-0">HS Support</span>
                            <span class="d-block font-size-sm text-body">Customer service and support</span>
        ...
        <ul class="navbar-nav navbar-nav-lg nav-tabs">
          ...
          <li class="navbar-vertical-aside-has-menu nav-footer-item ">
            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle " href="javascript:;" title="Language">
              <img class="avatar avatar-xss avatar-circle" src="{{asset('backend/assets/vendor/flag-icon-css/flags/1x1/us.svg')}}" alt="United States Flag">
            ...
            <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
              <li class="nav-item">
                <a class="nav-link" href="#" title="English (US)">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="{{asset('backend/assets/vendor/flag-icon-css/flags/1x1/us.svg')}}" alt="Flag">
                  English (US)
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="English (UK)">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="{{asset('backend/assets/vendor/flag-icon-css/flags/1x1/gb.svg')}}" alt="Flag">
                  English (UK)
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="Deutsch">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="{{asset('backend/assets/vendor/flag-icon-css/flags/1x1/de.svg')}}" alt="Flag">
                  Deutsch
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="Dansk">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="{{asset('backend/assets/vendor/flag-icon-css/flags/1x1/dk.svg')}}" alt="Flag">
                  Dansk
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="Italiano">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="{{asset('backend/assets/vendor/flag-icon-css/flags/1x1/it.svg')}}" alt="Flag">
                  Italiano
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#" title="中文 (繁體)">
                  <img class="avatar avatar-xss avatar-circle mr-2" src="{{asset('backend/assets/vendor/flag-icon-css/flags/1x1/cn.svg')}}" alt="Flag">
                  中文 (繁體)
                </a>
              </li>
            </ul>
  ...
  <div class="navbar-vertical-container">
    <div class="navbar-brand d-flex justify-content-center">
      <!-- Logo -->
        ...
        <a class="navbar-brand" href="index.html" aria-label="Front">
          <img class="navbar-brand-logo-short" src="{{asset('backend/assets/svg/logos/logo-short.svg')}}" alt="Logo">
        </a>
              ...
              <div class="card-body">
                ...
                <ul class="list-group list-group-flush list-group-no-gutters">
                  ...
                  <li class="list-group-item py-3">
                    <div class="media">
                      <div class="mt-1 mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="{{asset('backend/assets/svg/brands/capsule.svg')}}" alt="Image Description">
                      </div>
                      <div class="media-body">
                        <div class="row align-items-center">
                          <div class="col">
                  ...
                  <li class="list-group-item py-3">
                    <div class="media">
                      <div class="mt-1 mr-3">
                        <img class="avatar avatar-xs avatar-4by3" src="{{asset('backend/assets/svg/brands/mailchimp.svg')}}" alt="Image Description">
                      </div>
                      <div class="media-body">
                        <div class="row align-items-center">
                          <div class="col">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="table-column-pl-0">
                    <a class="media align-items-center" href="user-profile.html">
                      <div class="avatar avatar-sm avatar-circle mr-2">
                        <img class="avatar-img" src="{{asset('backend/assets/img/160x160/img9.jpg')}}" alt="Image Description">
                      </div>
                      <div class="media-body">
                ...
                <tr>
                  ...
                  <td class="table-column-pl-0">
                    <a class="media align-items-center" href="user-profile.html">
                      <div class="avatar avatar-sm avatar-circle mr-2">
                        <img class="avatar-img" src="{{asset('backend/assets/img/160x160/img4.jpg')}}" alt="Image Description">
                      </div>
                      <div class="media-body">
          ...
          <div class="modal-body p-sm-5">
            <div class="text-center">
              <div class="w-75 w-sm-50 mx-auto mb-4">
                <img class="img-fluid" src="{{asset('backend/assets/svg/illustrations/graphs.svg')}}" alt="Image Description">
              </div>
          ...
          <div class="modal-footer d-block text-center py-sm-5">
            ...
            <div class="w-85 mx-auto">
              <div class="row justify-content-between">
                <div class="col">
                  <img class="img-fluid ie-welcome-brands" src="{{asset('backend/assets/svg/brands/gitlab-gray.svg')}}" alt="Image Description">
                </div>
                <div class="col">
                  <img class="img-fluid ie-welcome-brands" src="{{asset('backend/assets/svg/brands/fitbit-gray.svg')}}" alt="Image Description">
                </div>
                <div class="col">
                  <img class="img-fluid ie-welcome-brands" src="{{asset('backend/assets/svg/brands/flow-xo-gray.svg')}}" alt="Image Description">
                </div>
                <div class="col">
                  <img class="img-fluid ie-welcome-brands" src="{{asset('backend/assets/svg/brands/layar-gray.svg')}}" alt="Image Description">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="form-row">
              ...
              <div class="col-auto">
                <a class="d-flex align-items-center font-size-sm text-body" href="#">
                  <img class="avatar avatar-xss mr-2" src="{{asset('backend/assets/svg/brands/gmail.svg')}}" alt="Image Description">
                  Import contacts
                </a>
              </div>
            </div>
          ...
          <div class="modal-footer justify-content-start">
            <div class="row align-items-center flex-grow-1 mx-n2">
              <div class="col-sm-9 mb-2 mb-sm-0">
                <input type="hidden" id="inviteUserPublicClipboard" value="../../themes.getbootstrap.com/product/front-multipurpose-responsive-template/index.html">
    ...
    <script src="{{asset('backend/assets/vendor/chart.js.extensions/chartjs-extensions.js')}}"></script>
    ...
    <!-- IE Support -->
    <script>
      if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write('<script src="{{asset('backend/assets/vendor/babel-polyfill/polyfill.min.js')}}"><\/script>');
    </script>
  </body>
